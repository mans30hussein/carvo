 ...
 /// All user-facing Arabic text for the auth feature in one place.
///
/// Previously these strings were hardcoded inline in each widget, which
/// meant fixing a typo or wording meant hunting across files. Centralizing
/// them here also makes future localization (adding English) a matter of
/// swapping this file's source, not touching every screen.
class AppStrings {
  const AppStrings._();
